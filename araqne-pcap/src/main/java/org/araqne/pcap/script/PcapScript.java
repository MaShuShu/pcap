 ...
 */
package org.araqne.pcap.script;
...
import org.araqne.pcap.decoder.tcp.TcpSession;
...
import org.araqne.pcap.util.Ping;
import org.araqne.pcap.util.Ping.PingResponse;
	...
	public void tcpReset(String[] args) {
		...
		for (TcpSession session : runner.getTcpDecoder().getCurrentSessions()) {
			try {
				...
				logger.error("araqne pcap: io error", e);
			}
		}
	}
